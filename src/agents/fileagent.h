...
private:
    ...
    /**
     * @brief 递归搜索目录下的文件
     * @param args 包含dir、pattern（可选）、maxDepth（可选）
     * @return 匹配的文件列表 JSON
     */
    ...
    /**
     * @brief 重命名文件或目录
     * @param args 包含oldName和newName参数
     * @return 重命名结果
     */
    ...
    /**
     * @brief 读取文件指定行范围
     * @param args 包含path、startLine（可选）、endLine（可选）参数
     * @return 指定行的内容
     */
